...
pub use actions::{Action, ShellType, PaneType};
pub use events::Event;
pub use plugins::{Plugin, PluginMetadata, PluginInfo, PluginContext};
pub use commands::*; // Re-export all Tauri commands
...
impl Manager {
    ...
    pub fn new_with_backend(
        ...
        let project_search = project_path
            .map(|path| Arc::new(ProjectSearch::new(path)));
