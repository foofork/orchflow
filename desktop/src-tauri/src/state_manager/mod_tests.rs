...
mod tests {
    ...
    async fn test_delete_pane() {
        ...
        let session = manager.create_session("Test".to_string()).await.unwrap();
        let pane = manager
            .create_pane(session.id.clone(), PaneType::Terminal, None)
            .await
            .unwrap();
    ...
    async fn test_set_active_pane() {
        ...
        let pane1 = manager
            ...
            .unwrap();
        let pane2 = manager
            .create_pane(session.id.clone(), PaneType::Editor, None)
            .await
            .unwrap();
    ...
    async fn test_pane_ordering() {
        ...
        let pane2 = manager
            ...
            .unwrap();
        let pane3 = manager
            .create_pane(session.id.clone(), PaneType::FileTree, None)
            .await
            .unwrap();
