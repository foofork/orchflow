...
mod tests {
    ...
    async fn test_terminal_resize() {
        ...
        // Resize terminal
        let control = ControlMessage::Resize {
            cols: 120,
            rows: 40,
        };
    ...
    async fn test_terminal_key_sequences() {
        ...
        // Test Ctrl+C
        let result = manager
            .send_input(&terminal_id, TerminalInput::Data("\x03".to_string()))
            .await;
        assert!(result.is_ok());
    ...
    async fn test_terminal_clear() {
        ...
        manager
            .send_input(
                &terminal_id,
                TerminalInput::Data("echo 'Line 1'\n".to_string()),
            )
            .await
            .unwrap();
        manager
            .send_input(
                &terminal_id,
                TerminalInput::Data("echo 'Line 2'\n".to_string()),
            )
            .await
            .unwrap();
        manager
            .send_input(
                &terminal_id,
                TerminalInput::Data("echo 'Line 3'\n".to_string()),
            )
            .await
            .unwrap();
    ...
    async fn test_terminal_error_handling() {
        ...
        let result = manager
            .send_input(fake_id, TerminalInput::Data("test".to_string()))
            .await;
        assert!(result.is_err());
    ...
    async fn test_terminal_working_directory() {
        ...
        manager
            .send_input(&terminal_id, TerminalInput::Data("pwd\n".to_string()))
            .await
            .unwrap();
    ...
    async fn test_terminal_concurrent_operations() {
        ...
        let handles = vec![
            ...
            tokio::spawn({
                ...
                async move {
                    manager
                        .send_input(&id, TerminalInput::Data("\t".to_string()))
                        .await
                }
            }),
        ];
