...
mod pty_manager_tests {
    use super::*;
    use crate::terminal_stream::pty_manager::{ProcessStatus, PtyManager};
    ...
    async fn test_write_to_pty() {
        ...
        {
            let result = handle
                .send_input(bytes::Bytes::from_static(b"echo test\n"))
                .await;
...
mod protocol_tests {
    use super::*;
    use crate::terminal_stream::protocol::{ControlMessage, TerminalInput};
