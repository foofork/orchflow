...
impl PluginRegistry {
    pub fn new() -> Self {
        ...
        registry.register("file-browser", || {
            Box::new(file_browser::FileBrowserPlugin::new())
        });
        registry.register("test-runner", || {
            Box::new(test_runner::TestRunnerPlugin::new())
        });
        registry.register("terminal", || {
            Box::new(terminal_plugin::TerminalPlugin::new())
        });
