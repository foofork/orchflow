#[cfg(test)]
mod tmux_backend_integration_tests {
    use crate::backend::{MuxBackend, PaneSize, SplitType};
    ...
    async fn test_tmux_pane_operations() {
        ...
        // Send keys
        backend
            .send_keys(&pane_id, "echo 'Hello from tmux test'")
            .await
    ...
    async fn test_tmux_error_handling() {
        ...
        let result = backend
            .create_pane("non-existent-session", SplitType::None)
            .await;
