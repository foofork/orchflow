/**
 * OrchFlow Configuration Manager - YAML configuration support
 * Manages configuration with validation and performance optimization
 */
...
export class OrchFlowConfigManager {
  private static instance: OrchFlowConfigManager;
  ...
  static getInstance(): OrchFlowConfigManager {
    if (!OrchFlowConfigManager.instance) {
      OrchFlowConfigManager.instance = new OrchFlowConfigManager();
    }
    return OrchFlowConfigManager.instance;
  }
...
export default OrchFlowConfigManager;