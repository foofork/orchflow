...
impl SearchCommands {
    ...
    pub async fn execute_search(&self, request: FileSearchRequest) -> Result<FileSearchResponse, String> {
        ...
        let mut results = searcher.search_files(file_refs, &matcher, &request.options).await?;
    ...
    pub async fn execute_replace(&self, request: ReplaceRequest) -> Result<ReplaceResponse, String> {
    ...
    pub async fn execute_search_and_replace(
        ...
        if search_response.results.is_empty() {
            return Ok((search_response, ReplaceResponse {
                results: vec![],
    ...
    pub fn get_supported_extensions(&self) -> Vec<String> {
        vec![
            ...
            "cs", "php", "rb", "swift", "kt", "scala", "clj", "ex", "elixir", "hs",
            "ml", "fs", "r", "m", "pl", "sh", "bash", "zsh", "fish", "ps1", "cmd",
            "html", "htm", "css", "scss", "sass", "less", "xml", "svg", "json", "yaml",
            "yml", "toml", "ini", "cfg", "conf", "properties", "env", "txt", "md",
            "rst", "org", "tex", "log", "sql", "graphql", "gql", "proto", "thrift",
            "dockerfile", "makefile", "cmake", "gradle", "pom", "sbt", "cargo"
