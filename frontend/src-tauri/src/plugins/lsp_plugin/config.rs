...
pub fn default_server_configs() -> HashMap<String, LanguageServerConfig> {
    ...
    // Rust Analyzer
    configs.insert("rust".to_string(), LanguageServerConfig {
    ...
    configs.insert("typescript".to_string(), LanguageServerConfig {
    ...
    configs.insert("python".to_string(), LanguageServerConfig {
    ...
    // Go Language Server
    configs.insert("go".to_string(), LanguageServerConfig {
...
pub fn get_language_for_file(file_path: &str, configs: &HashMap<String, LanguageServerConfig>) -> Option<String> {
