...
#[tauri::command]
pub async fn search_command_history_advanced(
    ...
    manager.command_history.search(
    ...
    .map_err(|e| crate::error::OrchflowError::DatabaseError {
        operation: "search_command_history_advanced".to_string(),
        reason: e.to_string(),
    })
}
...
pub async fn get_command_stats(
    ...
    manager.command_history.get_stats(limit).await
        .map_err(|e| crate::error::OrchflowError::DatabaseError {
...
pub async fn get_command_suggestions(
    ...
    manager.command_history.get_suggestions(
        &prefix,
        pane_id.as_deref(),
        limit.unwrap_or(10),
    ).await
...
pub async fn cleanup_command_history(
    ...
    manager.command_history.cleanup_old_entries(days_to_keep).await
        .map_err(|e| crate::error::OrchflowError::DatabaseError {
...
pub async fn export_command_history(
    ...
    manager.command_history.export_history(None, session_id.as_deref()).await
        .map_err(|e| crate::error::OrchflowError::DatabaseError {
...
pub async fn import_command_history(
    ...
    manager.command_history.import_history(&json_data).await
        .map_err(|e| crate::error::OrchflowError::DatabaseError {
