...
describe('FileTree', () => {
  ...
  describe('Rendering', () => {
    it('renders file node', () => {
      ...
      const { container } = render(FileTree, { props: { node } });
    ...
    it('renders with correct indentation', () => {
      const node = createNode();
      const { container } = render(FileTree, { props: { node, level: 2 } });
  ...
  describe('Interactions', () => {
    it('dispatches select and openFile on file click', async () => {
      ...
      const { container, component } = render(FileTree, { props: { node } });
  ...
  describe('Agent Status', () => {
    it('shows running agent status', () => {
      ...
      const { container } = render(FileTree, { props: { node, agents } });
